...
import { login, verify, registerDoctor } from '../lib/frontend_functions.js'
import get_jwt from '../lib/get_jwt.js'
...
const RegistrationPage = ({ setIsAuthenticated }) => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const response = await registerDoctor(
        ...
        formData.clinicName,
        formData.walkingAppointmentTiming,
        formData.videoConsultationCharges,
        formData.accountNumber,
        formData.branchName,
        formData.clinicRegistrationCertificate,
        formData.clinicAddress,
        formData.consultationCharges,
        formData.bankName,
        formData.ifscCode,
        formData.clinicSocialMedia,
        formData.clinicLetterhead
      );
    
          setRegistrationStatus(response.message);
          // Redirect or set isAuthenticated based on response
          if (response.success) {
  ...
  <div className={styles.gridContainer}>
    ...
    <div className={styles.gridItem}>
      <h3>Timing for walking appointment:</h3>
      <input
        type="text"
    ...
    <div className={styles.gridItem}>
      <h3>Video consultation charges:</h3>
      <input
        type="text"
        placeholder="Video consultation charges"
    ...
    <div className={styles.gridItem}>
      <h3>Clinic Registration certificate:</h3>
      <input
        type="text"
    ...
    <div className={styles.gridItem}>
    <h3>clints social media:</h3>
      <input
        type="text"
        placeholder="Clinic's social media"
        value={formData.clinicSocialMedia}
        onChange={(e) => setFormData({ ...formData, clinicSocialMedia: e.target.value })}
        className={styles.input}
        required
      />
    </div>
